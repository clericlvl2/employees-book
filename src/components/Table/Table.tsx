...
const Table = () => {
  ...
  return (
    <div className="light-scrollbar dark:scrollbar max-w-[500px] overflow-x-auto rounded-md border-[1px] border-neutral-400 p-2 dark:border-neutral-600">
      <table className="table">
        <thead>
          <tr className="border-[1px] border-neutral-400 bg-neutral-300 dark:border-transparent dark:bg-neutral-600">
            <th className="min-w-[10rem] px-2 text-start">Name</th>
